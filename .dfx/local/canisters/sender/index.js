...
import { idlFactory } from './sender.did.js';
export { idlFactory } from './sender.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SENDER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./sender.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the sender canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./sender.did.js")._SERVICE>}
 */
export const sender = createActor(canisterId);
