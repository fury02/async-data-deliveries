...
import { idlFactory } from './receiver.did.js';
export { idlFactory } from './receiver.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.RECEIVER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./receiver.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the receiver canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./receiver.did.js")._SERVICE>}
 */
export const receiver = createActor(canisterId);
